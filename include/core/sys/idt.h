...
void idt_init()
{
    ...
    IDT[32].offset_lowerbits = exc0_address & 0xffff;
    IDT[32].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[32].zero = 0;
    IDT[32].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[32].offset_higherbits = (exc0_address & 0xffff0000) >> 16;

    u64 exc1_address = (u64)exc1;
    IDT[33].offset_lowerbits = exc1_address & 0xffff;
    IDT[33].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[33].zero = 0;
    IDT[33].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[33].offset_higherbits = (exc1_address & 0xffff0000) >> 16;

    u64 exc2_address = (u64)exc2;
    IDT[34].offset_lowerbits = exc2_address & 0xffff;
    IDT[34].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[34].zero = 0;
    IDT[34].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[34].offset_higherbits = (exc2_address & 0xffff0000) >> 16;

    u64 exc3_address = (u64)exc3;
    IDT[35].offset_lowerbits = exc3_address & 0xffff;
    IDT[35].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[35].zero = 0;
    IDT[35].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[35].offset_higherbits = (exc3_address & 0xffff0000) >> 16;

    u64 exc4_address = (u64)exc4;
    IDT[36].offset_lowerbits = exc4_address & 0xffff;
    IDT[36].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[36].zero = 0;
    IDT[36].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[36].offset_higherbits = (exc4_address & 0xffff0000) >> 16;

    u64 exc5_address = (u64)exc5;
    IDT[37].offset_lowerbits = exc5_address & 0xffff;
    IDT[37].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[37].zero = 0;
    IDT[37].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[37].offset_higherbits = (exc5_address & 0xffff0000) >> 16;

    u64 exc6_address = (u64)exc6;
    IDT[38].offset_lowerbits = exc6_address & 0xffff;
    IDT[38].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[38].zero = 0;
    IDT[38].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[38].offset_higherbits = (exc6_address & 0xffff0000) >> 16;

    u64 exc7_address = (u64)exc7;
    IDT[39].offset_lowerbits = exc7_address & 0xffff;
    IDT[39].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[39].zero = 0;
    IDT[39].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[39].offset_higherbits = (exc7_address & 0xffff0000) >> 16;

    u64 exc8_address = (u64)exc8;
    IDT[40].offset_lowerbits = exc8_address & 0xffff;
    IDT[40].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[40].zero = 0;
    IDT[40].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[40].offset_higherbits = (exc8_address & 0xffff0000) >> 16;

    u64 exc10_address = (u64)exc10;
    IDT[42].offset_lowerbits = exc10_address & 0xffff;
    IDT[42].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[42].zero = 0;
    IDT[42].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[42].offset_higherbits = (exc10_address & 0xffff0000) >> 16;

    u64 exc11_address = (u64)exc11;
    IDT[43].offset_lowerbits = exc11_address & 0xffff;
    IDT[43].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[43].zero = 0;
    IDT[43].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[43].offset_higherbits = (exc11_address & 0xffff0000) >> 16;

    u64 exc12_address = (u64)exc12;
    IDT[44].offset_lowerbits = exc12_address & 0xffff;
    IDT[44].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[44].zero = 0;
    IDT[44].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[44].offset_higherbits = (exc12_address & 0xffff0000) >> 16;

    u64 exc13_address = (u64)exc13;
    IDT[45].offset_lowerbits = exc13_address & 0xffff;
    IDT[45].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[45].zero = 0;
    IDT[45].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[45].offset_higherbits = (exc13_address & 0xffff0000) >> 16;

    u64 exc14_address = (u64)exc14;
    IDT[46].offset_lowerbits = exc14_address & 0xffff;
    IDT[46].selector = 0x08; /* KERNEL_CODE_SEGMENT_OFFSET */
    IDT[46].zero = 0;
    IDT[46].type_attr = 0x8e; /* INTERRUPT_GATE */
    IDT[46].offset_higherbits = (exc14_address & 0xffff0000) >> 16;
